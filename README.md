This is the final project for CS 123 2024 fall, group 4.

To set up the experiments we have run, go to Pupper_MJX_RL_Actual_policy_notebook.ipynb It includes all the setups for training the policy.
...
Best of luck, and have fun parkouring!
